<template>
  <div class="bg-green-100 w-full min-h-screen">
    <div class="max-w-md mx-auto px-4 py-20">
      ...
      <form @submit.prevent="adminLogin" class="mt-6 space-y-6">
        <div>
          <label>Email</label>
          <input
            type="email"
            ...
            v-model="email"
            required
            class="w-full border shadow-xl rounded-lg"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          class="bg-green-500 w-full px-4 py-2 rounded-lg text-gray-200 font-semibold tracking-wider focus:outline-none focus:shadow-outline"
        >
